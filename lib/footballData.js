...
// Devuelve todos los partidos del Mundial, ordenados por fecha/hora de
// juego (orden cronologico real, sin separar jugados de pendientes).
export async function getAllMatches() {
  ...
  const data = (raw.matches || []).map(simplifyMatch).sort(byKickoff);
